...
| **Web frontend (stdlib HTML at GET /)** | **Stays** — housing | ADR-0006. Browser UI around the existing gate. Personality stays script data; engines stay a startup flag; POST /say remains the door. |
